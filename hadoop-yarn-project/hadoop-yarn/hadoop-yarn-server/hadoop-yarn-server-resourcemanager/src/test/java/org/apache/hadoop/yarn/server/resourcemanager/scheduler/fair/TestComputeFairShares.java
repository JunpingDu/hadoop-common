...
public class TestComputeFairShares {
  ...
  private ResourceCalculator comparator = new DefaultCalculator();
  @Before
  ...
  public void testEqualSharing() {
    ...
    SchedulingAlgorithms.computeFairShares(
        comparator, scheds, Resources.createResource(40));
  ...
  public void testWeightedSharing() {
    ...
    SchedulingAlgorithms.computeFairShares(
        comparator, scheds, Resources.createResource(45));
  ...
  public void testLargeShares() {
    ...
    SchedulingAlgorithms.computeFairShares(
        comparator, scheds, Resources.createResource(40 * million));
  ...
  public void testZeroDemand() {
    ...
    SchedulingAlgorithms.computeFairShares(
        comparator, scheds, Resources.createResource(30));
