...
class CSQueueUtils {
  ...
  public static void updateQueueStatistics(
    ...
    if (Resources.greaterThan(
        calculator, clusterResource, Resources.none())) {
      queueLimit = 
          Resources.multiply(clusterResource, childQueue.getAbsoluteCapacity());
      absoluteUsedCapacity = 
          Resources.divide(calculator, usedResources, clusterResource);
      usedCapacity = 
          Resources.divide(calculator, usedResources, queueLimit);
    }
