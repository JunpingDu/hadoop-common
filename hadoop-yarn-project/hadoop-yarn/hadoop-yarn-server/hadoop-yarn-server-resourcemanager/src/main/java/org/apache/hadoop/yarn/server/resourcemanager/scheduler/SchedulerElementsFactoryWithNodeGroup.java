...
public class SchedulerElementsFactoryWithNodeGroup extends
  ...
  @Override
  public FiCaSchedulerNode constructFiCaSchedulerNode(RMNode node) {
    return new FiCaSchedulerNodeWithNodeGroup(node);
  }

  @Override
  public FSSchedulerNode constructFSSchedulerNode(RMNode node) {
    return new FSSchedulerNodeWithNodeGroup(node);
  }
  ...
  public LeafQueue constructLeafQueue(CapacitySchedulerContext cs, String queueName,
      ...
      CSQueue old) {
    return new LeafQueueWithNodeGroup(cs, queueName, parent,
        applicationComparator, old);
  }
